...
async function defaultBuildCandidateVM(db, candidateId) {
  ...
  return {
    ...
    portfolio: row.portfolio_url || row.portfolio || "",
    ...
    valuesResonates: row.values_resonates || "",
    values_resonates: row.values_resonates || "",
    motivation: row.motivation || "",
    onsiteAvailable: row.onsite_available,
    onsite_available: row.onsite_available,
    terminationHistory: row.termination_history || "",
    termination_history: row.termination_history || "",
    referencesAvailable: row.references_available,
    references_available: row.references_available,
    workAuthorization: row.work_authorization,
    work_authorization: row.work_authorization,
    candidateExpectedSalaryRange: row.expected_salary_range || "",
    expected_salary_range: row.expected_salary_range || "",
    // Resume/cover letter
